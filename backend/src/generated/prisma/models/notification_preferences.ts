...
export type notification_preferencesWhereInput = {
  ...
  customer_id?: Prisma.UuidFilter<"notification_preferences"> | string
  email_marketing?: Prisma.BoolFilter<"notification_preferences"> | boolean
...
export type notification_preferencesOrderByWithRelationInput = {
  ...
  email_marketing?: Prisma.SortOrder
...
export type notification_preferencesScalarWhereWithAggregatesInput = {
  ...
  customer_id?: Prisma.UuidWithAggregatesFilter<"notification_preferences"> | string
  email_marketing?: Prisma.BoolWithAggregatesFilter<"notification_preferences"> | boolean
...
export type notification_preferencesUpdateInput = {
  ...
  email_marketing?: Prisma.BoolFieldUpdateOperationsInput | boolean
...
export type notification_preferencesOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"customer_id" | "email_marketing" | "updated_at", ExtArgs["result"]["notification_preferences"]>
...
export interface notification_preferencesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const notification_preferencesWithCustomer_idOnly = await prisma.notification_preferences.findMany({ select: { customer_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Notification_preferences and only return the `customer_id`
   * const notification_preferencesWithCustomer_idOnly = await prisma.notification_preferences.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Notification_preferences and only return the `customer_id`
   * const notification_preferencesWithCustomer_idOnly = await prisma.notification_preferences.updateManyAndReturn({
   *   select: { customer_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface notification_preferencesFieldRefs {
  readonly customer_id: Prisma.FieldRef<"notification_preferences", 'String'>
  readonly email_marketing: Prisma.FieldRef<"notification_preferences", 'Boolean'>
